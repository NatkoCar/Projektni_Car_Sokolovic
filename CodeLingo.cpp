...
void Zpitanja(int index[], int &t, string &pitanje, string &pita, string &tocan, string &odgovor, int &tocnihZaredom, int &brPitanja, int &bodovi, string &unos)
{
    {
        t = 0;
        fstream pit("C:\\Users\\sokol\\OneDrive\\Dokumenti\\GitHub\\Projektni_Car_Sokolovic\\Zlatkic.txt", ios::in);
        ...
        pit.close();
        t = 0;
        fstream toc("C:\\Users\\sokol\\OneDrive\\Dokumenti\\GitHub\\Projektni_Car_Sokolovic\\Ztocni.txt", ios::in);
